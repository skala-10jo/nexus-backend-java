...
public class ExpressionController {
    ...
    public ResponseEntity<ApiResponse<List<ExpressionResponse>>> getExpressionsByUnit(
            ...
            @AuthenticationPrincipal User user) {
        log.info("표현 목록 조회 요청: unit={}, limit={}, userId={}", unit, limit, user.getId());

        List<ExpressionResponse> expressions = expressionService.getExpressionsByUnit(unit, limit, user.getId());
